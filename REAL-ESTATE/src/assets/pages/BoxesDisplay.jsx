            ...
            <div className="w-full md:w-[60%] pr-5   md:pr-10 lg:pl-2">
                ...
                <div className=" mx-auto ">
                    {[
                        ...
                        <details
                            key={index}
                            className="mb-6 border-b border-gray-400 pb-2"
                    ...
                    {[0, 1, 2, 3].map((index) => {
                        ...
                        return (
                            <div
                                ...
                                rounded-lg transition-all duration-700 transform scale-90 opacity-0
                            ...
                            >
                                ...
                                <div className="w-7 h-7 md:w-9 md:h-9 lg:w-10 lg:h-10 flex items-center  justify-center bg-transparent rounded-full border-2 border-gray-500">
                                    <img src={checkIcon} alt="Check Icon" className="w-5 h-5 md:w-6 md:h-6" />
                                </div>
